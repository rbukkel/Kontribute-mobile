...
class SearchMyActivitiesState extends State<SearchMyActivities> {
  ...
  final _formmainKeyEvent = GlobalKey<FormState>();
  final _formmainKeyTicket = GlobalKey<FormState>();
  final _formmainKeygift = GlobalKey<FormState>();
  String deletegift;
  ...
  void getsortdata(String user_id, String sortval, String search) async {
    ...
    http.Response response =
        await http.post(Network.BaseApi + Network.myactivities, body: data);
        ...
        PopupMenuItem(
            ...
            child: GestureDetector(
              onTap: () {
                setState(() {
                  deleteGiftDialog(
                      listinggift.result.elementAt(index).id.toString());
                });
                Navigator.of(context).pop();
              },
              child: Row(
        ...
        PopupMenuItem(
            ...
            child: GestureDetector(
              onTap: () {
                setState(() {
                  print(
                      "Copy: " + listing.result.elementAt(index).id.toString());
                  _createDynamicLink(
                      listing.result.elementAt(index).id.toString());
                });
                Navigator.of(context).pop();
              },
              child: Row(
  ...
  Future<void> deleteGift(String id) async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.giftdelete, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  Future<void> deleteDonation(String id) async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.donationdelete, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  Future<void> deleteEvent(String id) async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.eventdelete, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  Future<void> deleteTicket(String id) async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.ticketdelete, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int index) {
                                imageslist_length = listing.result
                                    ...
                                    .projectImages;
                                commentlist_length =
                                    listing.result.elementAt(index).comments;
                                            ...
                                            onTap: () {
                                              setState(() {
                                                ...
                                                listing.result
                                                            ...
                                                            .userId ==
                                                        userid
                                                    ? _showProjectEditPopupMenu(
                                                        index)
                                                    : _showProjectPopupMenu(
                                                        index);
                                              });
                                            },
                                            child: Container(
                                                                                    ...
                                                                                    Widget continueButton = FlatButton(
                                                                                      ...
                                                                                      onPressed: () async {
                                                                                        if (_formmainKey.currentState.validate())
                                                                                          {
                                                                                            setState(() {
                                                                                              Payamount(listing.result.elementAt(index).id, AmountController.text, userid);
                                                                                            });
                                                                                          }
                                                                      ...
                                                                      image: DecorationImage(
                                                                          image: NetworkImage(
                                                                            Network.BaseApiProject +
                                                                                listing.result.elementAt(index).projectImages.elementAt(ind).imagePath,
                                                                          ),
                          ...
                          ? Expanded(
                              child: ListView.builder(
                                  ...
                                  itemBuilder:
                                    ...
                                    imageslist_length = listingdonation.result
                                        .elementAt(index)
                                        .projectImages;
                                    commentlist_length = listingdonation.result
                                        .elementAt(index)
                                        .comments;
                                    double amount = listingdonation.result
                                            .elementAt(index)
                                            .totalcollectedamount
                                            .toDouble() /
                                        double.parse(listingdonation.result
                                            .elementAt(index)
                                            .budget) *
                                        100;
                                    amoun = amount.toInt();
                                    reverid = listingdonation.result
                                        .elementAt(index)
                                        .userId
                                        .toString();
                                    return Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              GestureDetector(
                                                ...
                                                onTap: () {
                                                  listingdonation.result
                                                              .elementAt(index)
                                                              .userId ==
                                                          userid
                                                      ? _showDonationEditPopupMenu(
                                                          index)
                                                      : _showDonationPopupMenu(
                                                          index);
                                                },
                                                child: Container(
                                                  alignment: Alignment.topRight,
                                                                                        ...
                                                                                        Widget continueButton = FlatButton(
                                                                                          ...
                                                                                          onPressed: () async {
                                                                                            if (_formmainKeyDonation.currentState.validate()) {
                                                                                              setState(() {
                                                                                                PayDonationamount(listingdonation.result.elementAt(index).id, AmountController.text, userid);
                                                                                              });
                                                                                            }
                                                                                          },
                                                                                        );
                                                            ...
                                                            children: [
                                                              Container(
                                                                ...
                                                                child: Text(
                                                                  listinggift.result
                                                                      ...
                                                                      ? 'sendarequest'
                                                                          .tr
                                                                      : listinggift.result.elementAt(index).status ==
                                                                              "sent"
                                                                          ? 'sendto'
                                                                              .tr
                                                                          : listinggift.result.elementAt(index).status == "group"
                                                                              ? 'grouprequest'.tr
                                                                              : "",
                                                                  style: TextStyle(
                                                                      color: Colors
                                                              ...
                                                              userid ==
                                                                  ...
                                                                  ? GestureDetector(
                                                                      ...
                                                                      onTap:
                                                                          () {
                                                                        if (listinggift.result.elementAt(index).status ==
                                                                            "request") {
                                                                          _showGiftPopupMenu(
                                                                              index,
                                                                              "request");
                                                                        } else if (listinggift.result.elementAt(index).status ==
                                                                            "group") {
                                                                          _showGiftPopupMenu(
                                                                              index,
                                                                              "pool");
                                                                  ...
                                                                  ? listinggift.result.elementAt(index).profilePic !=
                                                                      ...
                                                                      ? Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              image: DecorationImage(
                                                                                  image: NetworkImage(
                                                                                    Network.BaseApiprofile + listinggift.result.elementAt(index).profilePic,
                                                                                  ),
                                                                                  fit: BoxFit.fill)),
                                                                        )
                                                                      : Container(
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          listinggift.result.elementAt(index).fullName != null
                                                                      ...
                                                                      GestureDetector(
                                                                        onTap:
                                                                            () {
                                                                          callNext(
                                                                              viewdetail_sendreceivegift(data: listinggift.result.elementAt(index).id.toString(), coming: "Ongoing"),
                                                                              context);
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      ...
                                                                      Container(
                                                                        ...
                                                                        child:
                                                                            Text(
                                                                          listinggift.result.elementAt(index).price != null
                                                                              ? "  \$" + listinggift.result.elementAt(index).price
                                                                              : listinggift.result.elementAt(index).minCashByParticipant != null
                                  ...
                                  ? Expanded(
                                      child: ListView.builder(
                                          ...
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            imageslist_length = listingevent
                                                .result
                                                .elementAt(index)
                                                .projectImages;
                                            commentlist_length = listingevent
                                                .result
                                                .elementAt(index)
                                                .comments;
                                                              ...
                                                              ? GestureDetector(
                                                                  onTap: () {
                                                                    callNext(
                                                                        viewdetail_profile(
                                                                            data:
                                                                                listingevent.result.elementAt(index).userId.toString()),
                                                                        context);
                                                                  },
                                                                  child:
                                                                      Container(
                                                      ...
                                                      style: TextStyle(
                                                          ...
                                                          'Poppins-Regular'),
                                                                  ...
                                                                  listingevent.result
                                                                              ...
                                                                              .toString() !=
                                                                          userid
                                                                      ? listingevent.result.elementAt(index).status ==
                                                                              "pending"
                                                                          ? GestureDetector(
                                                                              onTap: () {
                                                                                showDialog(
                                                                              ...
                                                                              child: Container(
                                                                                ...
                                                                                padding: EdgeInsets.only(right: SizeConfig.blockSizeHorizontal * 4, left: SizeConfig.blockSizeHorizontal * 4, bottom: SizeConfig.blockSizeHorizontal * 1, top: SizeConfig.blockSizeHorizontal * 1),
                                                                                decoration: BoxDecoration(
                                                                ...
                                                                child: Stack(
                                                                  ...
                                                                  children: <
                                                                    ...
                                                                    PageView
                                                                      ...
                                                                      physics:
                                                                          ClampingScrollPhysics(),
                                                                      itemCount: imageslist_length.length ==
                                                                              null
                                                                          ? 0
                                                                          : imageslist_length
                                                                              .length,
                                                                      ...
                                                                      itemBuilder:
                                                                        ...
                                                                        return Container(
                                                                          ...
                                                                          decoration: BoxDecoration(
                                                                              ...
                                                                              image: DecorationImage(
                                                                                  image: NetworkImage(
                                                                                    listingevent.result.elementAt(index).eventPath + listingevent.result.elementAt(index).projectImages.elementAt(ind).imagePath,
                                                                                  ),
                                                                                  fit: BoxFit.scaleDown)),
                                                                        );
                                                                      },
                                                                      ...
                                                                      ? GestureDetector(
                                                                          onTap:
                                                                            ...
                                                                            Widget
                                                                              ...
                                                                              onPressed: () async {
                                                                                if (_formmainKeyTicket.currentState.validate())
                                                                                  {
                                                                                    setState(() {
                                                                                      PayTicketamount(listingticket.result.elementAt(index).id, listingticket.result.elementAt(index).ticketCost, AmountController.text, userid);
                                                                                    });
                                                                                  }
                                                                              },
                                                                            );
                                                                            ...
                                                                            AlertDialog
                                                                                ...
                                                                                AlertDialog(
                                                                              title: Text(
                                                                                "Buy now Ticket price \$" + listingticket.result.elementAt(index).ticketCost.toString(),
                                                                                style: TextStyle(letterSpacing: 1.0, fontWeight: FontWeight.bold, fontFamily: 'Poppins-Regular', fontSize: 14, color: Colors.black),
                                                                              ),
                                                                              // content: Text("Are you sure you want to Pay this project?"),
                                                                              content: new Row(
                                                                                children: <Widget>[
                                                              ...
                                                              GestureDetector(
                                                                ...
                                                                onTap: () {
                                                                  listingticket
                                                                              ...
                                                                              .userId ==
                                                                          userid
                                                                      ? _showTicketEditPopupMenu(
                                                                          index)
                                                                      : _showTicketPopupMenu(
                                                                          index);
                                                                },
                                                                child:
                                                                    Container(
                                                              ...
                                                              listingticket.result
                                                                  ...
                                                                  ? GestureDetector(
                                                                      onTap:
                                                                          () {
                                                                        callNext(
                                                                            viewdetail_profile(data: listingticket.result.elementAt(index).userId.toString()),
                                                                            context);
                                                                      },
                                                                      child: Container(
                                                                          ...
                                                                          alignment: Alignment.center,
                                                                          margin: EdgeInsets.only(top: SizeConfig.blockSizeVertical * 2, bottom: SizeConfig.blockSizeVertical * 1, right: SizeConfig.blockSizeHorizontal * 1, left: SizeConfig.blockSizeHorizontal * 1),
                                                                          decoration: BoxDecoration(
                                                                            image:
                                                                                new DecorationImage(
                                                                              image: new AssetImage("assets/images/account_circle.png"),
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      listingticket.result.elementAt(index).userId.toString() ==
                                                                              userid
                                                                          ? Container()
                                                                          : GestureDetector(
                                                                              onTap: () {
                                                                          ...
                                                                          itemBuilder:
                                                                            ...
                                                                            return Container(
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                  ...
                                                                                  image: DecorationImage(
                                                                                      image: NetworkImage(
                                                                                        Network.BaseApiticket + listingticket.result.elementAt(index).ticketImages.elementAt(ind).imagePath,
                                                                                      ),
                                                                                      fit: BoxFit.scaleDown)),
                                                                            );
                                                                          },
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            child:
                                                                                Text(
                                                                              'invitation'.tr,
                                                                              style: TextStyle(color: Colors.black, fontFamily: 'Poppins-Bold', fontWeight: FontWeight.bold, fontSize: 16),
                                                                            ),
                                                                          ),
                                                                          Container(
                                                                            alignment:
                                                          ...
                                                          style: TextStyle(
                                                              ...
                                                              'Poppins-Regular'),
                                                                              ...
                                                                              Container(
                                                                                ...
                                                                                alignment: Alignment.topLeft,
                                                                                padding: EdgeInsets.only(left: SizeConfig.blockSizeHorizontal * 1, right: SizeConfig.blockSizeHorizontal * 3, top: SizeConfig.blockSizeHorizontal * 2),
                                                                                child: Text(
