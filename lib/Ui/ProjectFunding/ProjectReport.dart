...
class ProjectReport extends StatefulWidget {
  ...
  const ProjectReport({Key key, @required this.data})
      : super(key: key);
  @override
  ProjectReportState createState() => ProjectReportState();
}

class ProjectReportState extends State<ProjectReport> {
  ...
  bool internet = false;
  String valPost;
  ReportcommentPojo reportcommentPojo;
  ...
  Future<void> addReport(String post) async {
    ...
    http.Response response = await http.post(Network.BaseApi + Network.reportProject, body: data);
