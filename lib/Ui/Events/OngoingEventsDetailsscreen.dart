...
class OngoingEventsDetailsscreen extends StatefulWidget {
  ...
  const OngoingEventsDetailsscreen(
      {Key key, @required this.data, @required this.coming})
      : super(key: key);

  @override
  OngoingEventsDetailsscreenState createState() =>
      OngoingEventsDetailsscreenState();
}

class OngoingEventsDetailsscreenState
    extends State<OngoingEventsDetailsscreen> {
  ...
  void getData(String id, int projectid) async {
    ...
    http.Response response =
        await http.post(Network.BaseApi + Network.eventDetails, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  final List<Widget> introWidgetsList = <Widget>[
    Image.asset(
      "assets/images/chrimasevents.png",
      ...
      items: [
        PopupMenuItem(
            ...
            child: GestureDetector(
              onTap: () {
                setState(() {
                  print("Copy: " + projectdetailspojo.eventsdata.id.toString());
                  _createDynamicLink(
                      projectdetailspojo.eventsdata.id.toString());
                });
                Navigator.of(context).pop();
              },
              child: Row(
        ...
        PopupMenuItem(
            ...
            child: GestureDetector(
              onTap: () {
                ...
                callNext(
                    EventReport(
                        data: projectdetailspojo.eventsdata.id.toString()),
                    context);
              },
              child: Row(
                children: <Widget>[
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                mainAxisAlignment: MainAxisAlignment.start,
                                children: [
                                  projectdetailspojo.eventsdata.profilePic ==
                                              null ||
                                          projectdetailspojo
                                    ...
                                    children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          ...
                                          projectdetailspojo.eventsdata.userId
                                                      .toString() !=
                                                  userid
                                              ? projectdetailspojo
                                                          .eventsdata.status ==
                                                        ...
                                                        SharedUtils.readTerms("Terms").then((result){
                                                          if(result!=null){
                                                            if(result){
                                                              ...
                                                              print("falseValue");
                                                              warningDialog('pleasereadthetermsandconditionscarefullybeforepaying'.tr,"Event", context);
                                                            }
                                                          }else{
                                                            print("falseValue");
                                                            warningDialog('pleasereadthetermsandconditionscarefullybeforepaying'.tr,"Event", context);
                              ...
                              Container(
                                ...
                                child: new Html(
                                  data:
                                      projectdetailspojo.eventsdata.description,
                              ...
                              documentlist_length==null || projectdetailspojo.eventsdata.documents.isEmpty?Container():
                              Container(
                                height: SizeConfig.blockSizeVertical * 25,
                                child: ListView.builder(
                                    itemCount:
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Row(
                                                                    children: [
                                                                      Container(
                                                                        ...
                                                                        child: Row(
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              "  -\$" +
                                                                                  projectdetailspojo.eventsdata.contributerList.elementAt(idex).amount.toString(),
                                                                              style: TextStyle(
                                                                                  letterSpacing: 1.0,
                                                                                  color: Colors.black87,
                                                                                  fontSize: 10,
                                                                      ...
                                                                      projectdetailspojo.eventsdata.contributerList.elementAt(idex).status ==
                                                                              "0"
                                                                          ? Container(
  ...
  Future<void> addPost(String post) async {
    ...
    http.Response response = await http
        .post(Network.BaseApi + Network.post_eventComments, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  Future<void> Payamount(String id,String fees, String requiredAmount, String userid) async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.event_pay, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
  ...
  void addlike() async {
    ...
    var jsonResponse = null;
    http.Response response =
        await http.post(Network.BaseApi + Network.eventlikes, body: data);
    if (response.statusCode == 200) {
      jsonResponse = json.decode(response.body);
