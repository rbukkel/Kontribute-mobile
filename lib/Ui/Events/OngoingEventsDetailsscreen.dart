            ...
            child: GestureDetector(
              onTap: () {
                setState(() {
                  ...
                  _createDynamicLink(projectdetailspojo.eventsdata.id.toString());
                });
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          mainAxisAlignment: MainAxisAlignment.start,
                          children: [
                            projectdetailspojo.eventsdata.profilePic == null ||
                                  ...
                                  children: [
                                    GestureDetector(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(
                                          projectdetailspojo.eventsdata.fullName,
                                          style: TextStyle(
                                              letterSpacing: 1.0,
                                   ...
                                   /* GestureDetector(
                                    ...
                                    projectdetailspojo
                                        .eventsdata.userId.toString()!=userid?
                                    projectdetailspojo.eventsdata.status=="pending"?
                                    GestureDetector(
                                      onTap: ()
                                      {
                                        ...
                                        Widget continueButton = FlatButton(
                                          ...
                                          onPressed: () async {
                                            Payamount( projectdetailspojo
                                                .eventsdata.id, projectdetailspojo
                                                .eventsdata.entryFee,userid);
                                          },
                                        );
                        ...
                        projectdetailspojo.eventsdata.userId==userid?Container():
                        Column(
                          children: [
                            Container(
                              padding: EdgeInsets.only(
                          ...
                          child: ListView.builder(
                              ...
                              itemBuilder: (BuildContext context, int indx) {
                                return Container(
                                    ...
                                    child: Stack(
                                      children: [
                                        projectdetailspojo.eventsdata.videoLink.elementAt(indx).videoThumbnail==null||projectdetailspojo.eventsdata.videoLink.elementAt(indx).videoThumbnail==""?
                                        Container(
                                          height:
                                        ...
                                        InkWell(
                                          onTap: () {
                                            callNext(ProductVideoPlayerScreen(
                                                data: projectdetailspojo.eventsdata.videoLink.elementAt(indx).vlink.toString(),
