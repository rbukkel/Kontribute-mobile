...
/// country : "IN"
/// postalCode : "134109"
/// links : [{"params":{"rel":"self"},"href":"https://api.sandbox.hyperwallet.com/rest/v3/users/usr-829aaae5-e770-4b34-bd14-7c69a7d80b66/bank-accounts/trm-5a59169e-4ab3-4bfa-9ade-5cfe6a180c55"}]

class UpdateBankPojo {
  UpdateBankPojo({
      String token, 
      String type, 
      String status, 
  ...
  UpdateBankPojo.fromJson(dynamic json) {
    _token = json['token'];
    _type = json['type'];
    _status = json['status'];
...
/// params : {"rel":"self"}
/// href : "https://api.sandbox.hyperwallet.com/rest/v3/users/usr-829aaae5-e770-4b34-bd14-7c69a7d80b66/bank-accounts/trm-5a59169e-4ab3-4bfa-9ade-5cfe6a180c55"
