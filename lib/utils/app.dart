  ...
  return Row(
    ...
    children: [
      Container(
        ...
        child: Material(
            child: InkWell(
              ...
              child: Container(
                child: ClipRRect(
                  child: Image.asset("assets/images/back.png",width: 25,height: 25,color: Colors.black,),
                ),
              ),
            ),
          ),
      ...
      Container(
        ...
        margin:  EdgeInsets.only(top: SizeConfig.blockSizeVertical * 6,left: SizeConfig.blockSizeHorizontal*23),
        child: Text(text,
            ...
            InkWell(
              ...
              child: Container(
                color: Colors.transparent,
                  child: Image.asset("assets/images/back.png",width: 25,height: 25,),
              ),
            ),
      ),
      Container(
